...
data NewAction
    = NewAction { newActionUser :: UserData
...
data Projects
    = Projects' { projectsUser      :: UserData
...
data TrollsTimestamp
    = TrollsTimestamp { timestamp :: Integer }
    deriving Show
